...
Para visualizar el listado completo de los paquetes instalados podemos recurrir al comando ___library()___. 
Para conocer la totalidad de paquetes que se encuentran albergados en la CRAN, y a su vez verificar cuales de ellos se encuentran válidos y disponibles para su uso, empleamos los comandos:
```{r, eval=FALSE}
installed.packages()
available.packages()
```
